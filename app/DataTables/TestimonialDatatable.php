...
class TestimonialDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
			->addColumn('checkbox', 'admin.testimonial.btn.checkbox')
			->addColumn('edit', 'admin.testimonial.btn.edit')
			->addColumn('delete', 'admin.testimonial.btn.delete')
			->addColumn('image', 'admin.testimonial.btn.image')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
