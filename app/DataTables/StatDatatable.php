...
class StatDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
			->addColumn('checkbox', 'admin.stat.btn.checkbox')
			->addColumn('edit', 'admin.stat.btn.edit')
			->addColumn('delete', 'admin.stat.btn.delete')
			->addColumn('image', 'admin.stat.btn.image')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
