...
class HourDatatable extends DataTable {
	...
	public function dataTable($query) {
		return datatables($query)
			->addColumn('checkbox', 'admin.hour.btn.checkbox')
			->addColumn('edit', 'admin.hour.btn.edit')
			->addColumn('delete', 'admin.hour.btn.delete')
			->addColumn('image', 'admin.hour.btn.image')
			->rawColumns([
				'edit',
				'delete',
				'checkbox',
