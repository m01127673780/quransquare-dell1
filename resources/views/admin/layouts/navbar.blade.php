...
<!-- ============================ -->
   <li class="treeview {{ active_menu('courses')[0] }}">
    <a href="#">
      <i class="fa fa-question-circle-o"></i> <span>{{ trans('admin.courses') }}</span>
      <span class="pull-right-container">
       </span>
    </a>
    <ul class="treeview-menu" style="{{ active_menu('courses')[1] }}">
      <li class=""><a href="{{ aurl('courses') }}"><i class="fa  fa-question-circle-o"></i> {{ trans('admin.courses') }}</a></li>
