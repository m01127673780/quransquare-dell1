...
<!--   {{--================================================================== --}}
 -->     
  <div class="form-group">
        ...
        {!! Form::text('name_ar',$testimonial->name_ar,['class'=>'form-control']) !!}
     </div>
     <div class="form-group">
        {!! Form::label('name_en',trans('admin.name_en')) !!}
        {!! Form::text('name_en',$testimonial->name_en,['class'=>'form-control']) !!}
     </div> 
     <div class="form-group">
        {!! Form::label('text_ar',trans('admin.text_ar')) !!}
        {!! Form::text('text_ar',$testimonial->text_ar,['class'=>'form-control']) !!}
     </div>
     <div class="form-group">
        {!! Form::label('text_en',trans('admin.text_en')) !!}
        {!! Form::text('text_en',$testimonial->text_en,['class'=>'form-control']) !!}
     </div>
 
 <div class="form-group">
        {!! Form::label('job_ar',trans('admin.job_ar')) !!}
        {!! Form::text('job_ar',$testimonial->job_ar,['class'=>'form-control']) !!}
     </div>
     <div class="form-group">
        {!! Form::label('job_en',trans('admin.job_en')) !!}
        {!! Form::text('job_en',$testimonial->job_en,['class'=>'form-control']) !!}
     </div>
  <div class="form-group">
        {!! Form::label('country_ar',trans('admin.country_ar')) !!}
        {!! Form::text('country_ar',$testimonial->country_ar,['class'=>'form-control']) !!}
     </div>
     <div class="form-group">
